...
export function DevPanel({ onLogout }: DevPanelProps) {
  ...
  useEffect(() => {
    ...
    const devUser = sessionStorage.getItem("devUser")
    if (devUser) {
      setUsername(devUser)
    }
  ...
  const handleLogout = () => {
    sessionStorage.removeItem("devAccess")
    ...
    <div className="space-y-6 p-6 max-h-[80vh] overflow-y-auto">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-white">Developer Controls</h2>
        ...
        <Card className="bg-gray-900 border-gray-700">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="bg-gray-800/50 rounded-lg p-3 border border-gray-700">
              <div className="text-sm font-medium text-white mb-1">Developer Notes</div>
              <div className="text-xs text-gray-400">
                <p>
